...
public protocol SolidityFunctionHandler: AnyObject {
    ...
    func callRawResponse(_ call: EthereumCall, outputs: [SolidityFunctionParameter], block: EthereumQuantityTag, completion: @escaping (EthereumData?, Error?) -> Void)
...
public class SolidityConstantFunction: SolidityFunction {
    ...
    public func invokeWrapped(_ inputs: [SolidityWrappedValue]) -> SolidityInvocation {
        return SolidityReadInvocation(method: self, parameters: inputs, handler: handler)
    }
}
