...
public protocol ERC721Contract: ERC165Contract {
    ...
    func safeTransferFrom(from: EthereumAddress, to: EthereumAddress, tokenId: BigUInt) -> SolidityInvocation
...
open class GenericERC721Contract: StaticContract, ERC721Contract, EnumeratedERC721 {
