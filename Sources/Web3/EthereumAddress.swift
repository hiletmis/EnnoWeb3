...
public struct Web3Tupple: Codable {
    public let address: EthereumAddress
    public let callData: String
    
    public init(address: EthereumAddress, callData: String) {
        self.address = address
        self.callData = callData
    }
    
    public init(address: EthereumAddress, balanceRequestAddress: EthereumAddress) {
        let balanceRequest = balanceRequestAddress.hex(eip55: false).replacingOccurrences(of: "0x", with: "70a08231000000000000000000000000")
        self.init(address: address, callData: balanceRequest)
    }
}
